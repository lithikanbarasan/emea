  ...
  <div style={{ padding: '1.5rem 1.5rem', fontFamily: 'Arial, sans-serif', lineHeight: '1.6', maxWidth: '1200px', margin: '0 auto' }}>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', alignItems: 'center' }}>
        <img src={TaskReminderImg} alt="Task Reminder" style={{ width: '150px', borderRadius: '12px' }} />
        <img src={EOGDoctorImg} alt="EOG" style={{ width: '150px', borderRadius: '12px' }} />
      </div>
      ...
      {/* Right Column - Images */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', alignItems: 'center' }}>
        <img src={ActivityTrackingImg} alt="Activity Tracking" style={{ width: '150px', borderRadius: '12px' }} />
        <img src={AwarenessForumImg} alt="Awareness Forum" style={{ width: '150px', borderRadius: '12px' }} />
      </div>
    </div>
  </div>
);
